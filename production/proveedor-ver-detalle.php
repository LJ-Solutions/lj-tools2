            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left input_mask" method="post" action="procesos/p-proveedor-ver-detalle.php">

                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="proveedor-nombre-comercial" placeholder="Leno's weed" >                        
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="proveedor-nombre-contacto" placeholder="Lenon" >
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div> 
                     
                     <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-right" name="celular" placeholder="0915419964"> <!--SHOULD BE CUSTOM-->                       
                        <span class="fa fa-phone form-control-feedback right" aria-hidden="true"></span>
                      </div>   

                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="email" class="form-control has-feedback-left" name="email" placeholder="lenon@weed.com"> <!--SHOULD BE CUSTOM-->
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!--<form class="form-horizontal form-label-left input_mask">-->
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="direccion1" placeholder="Dirección 1">                        
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" name="ciudad" placeholder="Ciudad">                        
                  ...
                  <div class="x_content">
                    ...
                    <!--<form class="form-horizontal form-label-left input_mask">-->			
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">                        
                        <input type="checkbox" name="productos[]" id="producto1" value="producto1" class="flat" checked /> producto1
                        <br />
						<br />
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                        ...
                        <br />
                        <br />
                        <input type="checkbox" name="productos[]" id="producto4" value="producto4" class="flat" checked/> producto4
                        <br />                  
                      </div>
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                        ...
                        <br />
                        <br />
                        <input type="checkbox" name="productos[]" id="producto6" value="producto6" class="flat" checked/> producto6
                        <br />                       
                      </div>                      
                    ...
                    <!--<form class="form-horizontal form-label-left input_mask">-->			
                      ...
                      <div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                        <input type="checkbox" name="productos[]" id="producto5" value="producto5" class="flat" checked /> producto5
                        <br />
                        <br />
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        ...
                        <br />
                        <br />
                        <input type="checkbox" name="productos[]" id="producto8" value="producto8" class="flat" checked/> producto8
                        <br />                             
                      </div>
