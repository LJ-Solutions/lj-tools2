            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel"><!---->
                  ...
                  <div class="x_content">
                    <br />                    
                    <form class="form-horizontal form-label-left input_mask" method="post" action="procesos/p-ventas-crear-categoria.php">
                      <h2>                      	
                        <button type="button" class="btn btn-primary"><span class="fa fa-plus"></span></button>                        
