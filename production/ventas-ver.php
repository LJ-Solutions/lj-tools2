              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                    <input type="text" class="form-control" placeholder="Buscar # de venta">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />                     
                      ...
                      <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">                        
                        <label for="name">Cliente <span class="fa fa-sort"></span></label>
                        <br />            
                      </div>  
                      <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">                        
                      ...
                      <form method="post" action="ventas-ver-detalle.php">
                      <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
